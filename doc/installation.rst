...
1. Octopus-toolkit_2.0.6 : (:download:`Octopus-toolkit<_templates/Octopus-toolkit.zip>`) (64bit)
2. Octopus-toolkit_mac_2.0.6 : (:download:`Octopus-toolkit_mac<_templates/Octopus-toolkit_mac.zip>`)
...
To run the Octopus-toolkit, ``Java 8`` (JDK, Java Development ToolKit) or higher, must be installed on your computer. (:download:`Octopus-toolkit_mac_2.0.6<_templates/Octopus-toolkit_mac.zip>`)
